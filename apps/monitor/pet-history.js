...
(() => {
    ...
    const source = row => ({ generated: 'AI 生成', 'generated-animation': 'AI 动作序列合成', 'animation-source': '动作序列原图', 'background-removal': '去背景', 'proportion-repair': '旧图比例校正', upload: '上传图片' }[row.source]);
